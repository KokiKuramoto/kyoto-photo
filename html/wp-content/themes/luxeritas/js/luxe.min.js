...
if(luxeGetStyleValue(skeepid,"max-width")!=='32767px'){stick_watch();}var S=false,skprsz=("resize",function(){if(S===false){requestAnimationFrame(function(){S=false;if(d.getElementById('sidebar')!==null){sHeight=0;if(skeepid!==null)skeepid.style.minHeight="";if(luxeGetStyleValue(skeepid,"max-width")!=="32767px"){stick_watch();}else{skeep.trigger("sticky_kit:detach");}}});S=true;}});w.addEventListener("resize",skprsz,false);var e,r,p,y,top=0,navhid=0,mnav,hidfgt,hidfgb,nowpos=0,opos=-1,stkeve,v=luxeGetStyleValue;function thk_nav_stick(){top=0;if(d.getElementById('wpadminbar')!==null){top+=d.getElementById('wpadminbar').offsetHeight;}
thk_unpin(navid);mnav=luxeGetStyleValue(mob,"display");e=d.getElementById("nav");r=(e!==null?e.getBoundingClientRect():'');y=w.pageYOffset;hidfgt=r.top+y;navhid=top-(e!==null?e.offsetHeight:0)-1
T=false;if(y>hidfgt){thk_pin(e,top,'');}
T=false;stkeve=("scroll",function(){if(T===false){requestAnimationFrame(function(){T=false;p=d.querySelector(".pin")
if(w.pageYOffset<=hidfgt){thk_unpin(e);}else if(p===null){thk_pin(e,top,'');}});T=true;}});luxeListenScroll(stkeve);}
thk_nav_stick();var R=false;w.addEventListener("resize",function(){if(R===false){requestAnimationFrame(function(){R=false;e.style.width="";offsetCalc();});R=true;}},false);function thk_pin(o,sp,trs,cls){var s=o.style;if(typeof trs==="undefined")var trs="all .5s ease-in-out";if(typeof cls==="undefined")var cls="pin";s.transition=trs,s.top=sp+d.getElementById("head-band").offsetHeight+"px",s.position="fixed",s.width=o.clientWidth+'px'
